...
| <code><a href="#cdk-ecs-fargate-task-fis.FargateTaskDefinitionFaultInjection.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-ecs-fargate-task-fis.FargateTaskDefinitionFaultInjection.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-ecs-fargate-task-fis.FargateTaskDefinitionFaultInjection.with.parameter.mixins"></a>
